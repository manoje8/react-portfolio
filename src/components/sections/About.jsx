...
const About = ({ title, setTitle }) => {
  ...
  return (
    <div
      ref={aboutRef}
      className="relative bg-green min-h-screen flex flex-col justify-center items-center"
    >
        ...
        <div className="flex justify-between items-center gap-2">
          ...
          <div className="pointer-events-auto flex justify-center items-center p-2 gap-1 bg-white text-black rounded-lg shadow-lg">
            <button
              ...
              className="bg-black py-1.5 px-[10px] text-white text-sm md:text-xl rounded-lg cursor-pointer"
            >
              m
            </button>
            <div className="flex items-center justify-center gap-1 text-xs sm:text-sm md:text-md">
              {header.map((item, idx) => (
                <a href={`#${item.toLowerCase()}`} className={`text-center p-1`} key={idx}>
                  {item}
                </a>
              ))}
            </div>
      ...
      <div className="w-full flex flex-col md:flex-row justify-between px-4 sm:px-6 md:px-10 pt-20 pb-6 z-[100] gap-8">
        ...
        <div className="w-full md:w-3/5 text-left text-sm md:text-lg lg:text-xl leading-relaxed">
          ...
          <p className="mano-about mb-3">
            Hello! I am Software Engineer with 2 years of experience in full-stack development and a
            growing focus on AI/ML engineering.
          </p>

          <p className="mano-about mb-3">
            Skilled in Python, Java, JavaScript, and modern frameworks, with hands-on projects in
            machine learning, time series analysis, and API-driven systems.
          </p>

          <p className="mano-about">
            Seeking a Software Engineer role to contribute to scalable solutions and AI-driven
            applications.
          </p>
        ...
        <div className="w-full md:w-2/5 flex flex-col justify-between gap-6">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="w-full bg-white flex align-center justify-center mb-2 rounded-md"
          >
